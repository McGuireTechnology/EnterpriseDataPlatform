@{
    RootModule = 'Semperis-Lib.psm1'
    ModuleVersion = '1.326.0'
    Description = 'Semperis Security Indicators Shared Module'

    Author = 'Semperis'
    CompanyName = 'Semperis Inc.'
    Copyright = '© 2022 Semperis Inc.'

    GUID = '4cd35865-d32a-4faa-b666-58cdc42e47ef'
    ...
    FunctionsToExport = @(
        ...
        'Get-DomainSID'
        'Get-UACSet'
        'Get-SupportedEncryptionTypesSet'
        'Get-ADSearchFlag'
        'Convert-StringToXml'
        'Get-TrustAttributesSet'
        'Update-NTSecurityDescriptor'
        'Update-AttributeMetadata'
        'Update-ValueMetadata'
        'Get-AdminsInDomain'
        'Update-IndicatorOutputAttackWindow'
        'Update-GraphApiAADIndicatorOutputAttackWindow'
        'Search-ADHelper'
        'ConvertTo-ErrorResult'
        'Get-NetBIOSName'
        'Get-HostSPNMapping'
        'Compare-DSPMultiValuedAttribute'
        'Resolve-DomainName'
        'Resolve-DomainCredential'
        'Confirm-DomainAvailability'
        'Get-ForestSID'
        'Search-ADConfig'
        'Get-linkedOU'
        'Get-GPOValue'
        ...
        'ConvertTo-GraphApiErrorResult'
        'Get-GraphApiRequiredPermission'
        'Get-PrivilegedAdmins'
        'Search-AADIdentity'
        'Get-AADIdentityOwner'
        'Get-AADIdentityType'
        'Test-ConditionalMFAStrength'

        # Okta API
        'Invoke-OktaApiRequest'
    )
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC4ppNCok5Y1Owv
# 8JI1i6/x6CSU4m21R1ZwnUFXXTP/NKCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgDqUmKLazTk7EJGB+10ffVYnOk09GE3Ikw7fVAqzt9lgwDQYJKoZI
# hvcNAQEBBQAEggIAAvlXe1PoVvNGK+152m8Ok/S0IQCpEDJAznwHS3GnAQNH5MHW
# pEbAH0LsX5f3wLqcbZHQ1S+2Hd6E/7V0Kc82IA5nKDK6FfoVbIXFR0AxWXWhl8AL
# cGQzVAKeKKg3CW2zIipG4WmqKrCppLMlEUhJwxUW0q4OopZKkqok1HRepql6bsel
# wkvAudQhmXKxrbk+RW5QMQoUCVzLi+wzdUY7Koz64iYKHhjA1n3WT1VxfJRMzlh4
# 8cC7r9AdcpSz00vptb3nNUbR4ieubKtb738INttV6ohJ1TDTejTAw4F8eH0TBgxs
# GixBWvjSVpzg7fv+TfAC9M3VjpEaVak/AXDF0rhY7LJHishLegxj3VhxD3I8tnfs
# 2q5EwDKX+LPnp5yLa76mFUbjUIi0QeUg+lElNu9R0XyHEVQCrCXsj7AaI3sxsSPD
# 8rt4awOMZ//rCxBI6ANq0cH8AbtbX6A/ZQPCJM1ag4ltkIQwjHJPLIE8PGKTskl4
# wuc7kMn0mCdmPKS0XSsdv1FDbYsKiK4lUoYIQNc0RvXZNr5Cj7TsQhU3y/VfrTd4
# eN0HowosJaINr32BYb3SSVWUEI9XvbLLQ7kyHmUr/3d0JyZJVTei9B7O8KKbC7WU
# kXjU1edmzsX5ee1QkwEjIrJPDWPfYXF5rRJV/s2eGKBAg+8vQfnSmogzFZehgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCBwcmtojxYkLJs7rjwL21njAaR4+81UxnXG
# vpj2ioWHSAIUV2yMj0R5qENK9v9rgcBstqE7vZ0YDzIwMjUwNjEwMDc1MjE1WjAD
...
# MC8GCSqGSIb3DQEJBDEiBCBGvK161At8RyJspq7l0tdIgcK9lu+zWK/2N266hY6Q
...
# CwUABIIBgBGgkRDGq23GNU/FeBJKrJ0SukdPcx7ogwVRx2+kBIGWkzo304qxSerK
# EHf6Gn5IJ4K2yXev6cNunYuyDznUQqYbNYQDe3FXSbRGuDHMRfZQIcbi1m+lgr++
# LfXVEfjnbnNBTeLFG7kGY2xN6m0Sc9XI4QLWbYO9rDtaYWtUPMhuCqdQET2wLh7P
# 0YxfZeq6vcm0eKYU20iBStB/emRNUHoTDODR+xQw8AusvPRS8MSuHkfN+C4Yr0qG
# qkQ108f4ZzW7RvO2gtMa7IUCLlLCj/aO2jEd1xKI8QXP7MHtKMF/xUURt7le4QUC
# O2uElFF3mBTS/ss5l0EVB95If/J+9uMpVPdtUhLyknAtr2u25t4L6cMe2AEhnguu
# EX1ZkUSJbSePAoQg6PV42oB5qNisF8lKb9NaR8mPzUf/jhGIo2uV6XjtURT8a4iM
# Sjt2NZU01tjPQ+sn8s4maf5gqOyAVXiX/dJfLZPOJmQLimu8+1V8HakajklzM+3F
# bBVPql0aTg==
