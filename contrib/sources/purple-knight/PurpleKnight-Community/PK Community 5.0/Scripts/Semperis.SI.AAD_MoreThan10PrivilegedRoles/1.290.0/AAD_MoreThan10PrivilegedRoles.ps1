...
$Global:self = @{
    ID = 219
    UUID = 'c687bf2a-e2b6-4a8e-8651-c0f7c79a4338'
    Version = '1.290.0'
    CategoryID = 6
    ShortName = 'SI000219'
    Name = 'More than 10 Privileged Administrators exist'
    ScriptName = 'AAD_MoreThan10PrivilegedRoles'
    Description = '<p>This indicator checks for the presence of 10 or more Privileged Assigned Roles.</p>
    ...
    Schedule = '7d'
    Impact = 2
    LikelihoodOfCompromise = '<p>Users that hold the a privileged assigned role are one of the most privileged users in Entra ID. Organizations should limit the number of privileged roles to less than ten.</p>
      <p>An attacker will find users with the privileged role as high-value, and a compromised privileged role can lead to several attacks against the organization, that can include data exfiltration, lateral movement into other systems in Azure, multi-cloud, and on-premise systems, and can result in complete tenant compromise where an organization becomes locked out of their Entra tenant by the attacker.</p>
      <h3>References</h3>
      ...
      <p><a href="https://learn.microsoft.com/en-us/entra/identity/role-based-access-control/best-practices#6-limit-the-number-of-privileged-role-assignments-to-less-than-10" target="_blank">Best practices for Microsoft Entra roles - Microsoft Entra ID | Microsoft Learn</a></p>
    ...
    ResultMessage = 'Found {0} privileged roles in Azure AD.'
    Remediation = '<p>Review the users assigned the selected privileged role, and determine if the role assignment can be removed.</p>
      <p>To review and manage role assignments, open the <a href="https://entra.microsoft.com/#view/Microsoft_AAD_UsersAndTenants/UserManagementMenuBlade/%7E/UserSettings/menuId/UserSettings" target="_blank">Microsoft Entra admin center</a> (direct link), expand <b>Identity</b>, select <b>Show more</b>, expand <b>Roles &amp; admins</b>, and select <b>Roles &amp; admins</b>.</p>
      <p>In the blade on the right, find the <b>privileged roles</b> role. Select each privileged role.</p>
      ...
      <p><b>Organizations must ensure that any removal of the privileged role assignment does not impact the ability to manage their Entra tenant</b>.</p>'
    Types = @('IoE')
    ...
    OutputFields = @(
        ...
        @{ Name = 'Roles'; Type = 'String'; IsCollection = $false },
...
try {
    ...
    if ($outputObjects.Count -gt 10) {
        ...
        $rolesAfterIngore = $outputObjects.Count - $scoreOutput.Ignoredcount
        if ($rolesAfterIngore -gt 10) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBvM/8QzyPRfCI1
# 51/roIyqEc0XmSXBsPSvoao7QNeecaCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQg4jOoACFnv3KMpkfhbgKUMJEm8YAkZYs9VtlXIVQBf3gwDQYJKoZI
# hvcNAQEBBQAEggIAJgbuXaYD3UPYNfh/3vVmsnqQ9dfjJaufOEFdqaTZj9BcXAoq
# pEDFBHR+EUJpj2Taz2rqJy/s6fva4Htn/w7yD2TZiJS6Ap3/ZiC2LKOkshcLxDD7
