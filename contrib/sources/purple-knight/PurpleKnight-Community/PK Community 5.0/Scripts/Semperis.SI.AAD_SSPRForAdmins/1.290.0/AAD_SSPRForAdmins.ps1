...
$Global:self = @{
    ID = 227
    UUID = '0cf1fcb7-9867-4f09-8644-49daaf2eb228'
    Version = '1.290.0'
    CategoryID = 6
    ShortName = 'SI000227'
    Name = 'Self-service password reset enabled for privileged roles'
    ScriptName = 'AAD_SSPRForAdmins'
    Description = '<p>This indicator checks whether users in privileged roles in Entra ID can use self-service password reset.</p>
    ...
    Schedule = '1d'
    Impact = 6
    LikelihoodOfCompromise = '<p>Self-service password reset (SSPR) is beneficial in organizations for end users but has security trade-offs for privileged accounts. For details on the full list of privileged roles impacted by this, see the reference article.</p>
      <p>Attackers can and will target privileged users for compromise. Not all methods available for SSPR are phishing-resistant, and an attacker can leverage this to gain access to a privileged users account.</p>
      <h3>References</h3>
      <p><a href="https://learn.microsoft.com/en-us/entra/identity/authentication/concept-sspr-policy" target="_blank">Self-service password reset policies - Microsoft Entra ID | Microsoft Learn</a></p>
      <p><a href="https://learn.microsoft.com/en-us/graph/api/resources/authorizationpolicy?view=graph-rest-1.0" target="_blank">authorizationPolicy resource type - Microsoft Graph v1.0 | Microsoft Learn</a></p>'
    ResultMessage = 'SSPR is enabled for privileged roles.'
    Remediation = '<p>Disable SSPR for privileged roles.</p>
      <p>To disable SSPR for privileged roles, you cannot use the Entra admin center. Organizations must use either the Microsoft Graph API or the Microsoft Graph PowerShell SDK to disable SSPR for privileged roles. See the reference articles for details on how to disable. The policy setting <b>AllowedToUseSSPR</b> should be set to false.</p>
      <p>Organizations must ensure that disabling SSPR for privileged roles does not negatively impact their ability to administer their Entra tenant, and should ensure their break-glass accounts are working and maintained prior to disabling.</p>'
    Types = @('IoE')
...
try {
    ...
    try {
        $policy = Invoke-GraphApiRequest @getPolicy
    }
    catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAvP61jQfgfoPun
# 0Jjiu1hk5mMCNevNLku1Mn/0Ui/k26CCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgD2wPhjhb1cTiEDUZ26ZjD8YTZ600rL5Z44KdcJtuT2wwDQYJKoZI
# hvcNAQEBBQAEggIAT0GpoxFxmINWYCB0+smpMC6Ua6U4zb0k++u8T9s2wshw2M3i
# AODS34HDx2EQgTtUB7ZygIvrEdB1hN3PwN+bENSwe6yGISz+YjrvcGzlWrvt0Lxh
# Cd723BGgQ72BntCYrLRT+a52A6xV2NvZY3dOeIXK1aKhKqZR9Bbb4cYVYaniM0qi
