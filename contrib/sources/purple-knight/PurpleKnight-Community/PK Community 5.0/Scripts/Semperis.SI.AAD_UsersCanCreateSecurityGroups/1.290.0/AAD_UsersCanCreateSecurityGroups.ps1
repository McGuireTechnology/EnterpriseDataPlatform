...
$Global:self = @{
    ...
    Description = '<p>This indicator checks if non-admin users can create security groups.</p>
    ...
    LikelihoodOfCompromise = '<p>By default all users are allowed to create security groups in an Entra tenant.</p>
      <p>While many organizations may desire users to be able to create M365 groups for collaborations, valid cases for users creating security groups are generally limited.</p>
      <p>Entra ID does not require unique group names, and an attacker may create malicious security groups with duplicate names of valid groups, in an effort to have the malicious group assigned further privileges.</p>
      <h3>References</h3>
    ...
    Remediation = '<p>Disable <b>Users can create security groups</b> in the Entra tenant.</p>
    ...
    <p>In the blade on the right, toggle <b>Users can create security groups</b> to <b>no</b>.</p>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCByNUvFPOSCdTHQ
# Q5fXX6eWUOlOiNfGib89j9P0Le6/YKCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgmF5fKuaqJHO0Td3nnqrTkLOMd0N6Myj9qeeMkAhbXZMwDQYJKoZI
# hvcNAQEBBQAEggIAV3ljGmwJfrrevhtxrAi2TmZ9bAHhjTsJJ7YYjSZJ5SVagLhZ
# ngUXYx+sd2dgCAPVEnAEVRrp9ATSfRUEurlArm+hRycUVD7OPltO8OU+OnkMI0VJ
# +qRikhGED15Jtq86LyLxHIlnxZnxYhZT4SaZfWeESyDe5CsWSQEvFS1T6TZ2wPFC
# VW1Q0C1kKOIItCIdkCPGWLJH0E2cOs1xs2Rvo3Goayvz8OiFCwMoCGNvmU3F0raN
# t1NmukIuVPkUv8Mr/dz0tbIrVv7UxG0rJ+W41ko50n77sdmCmMkUIvIL1aTt0Is+
# VbL46/RE2d1hlU+CvzYp56mvbWa4wlRffA6ij+VUApHGGZVK3IafQ9u//syXWaWd
# YQLgue1FdwLnQfTHKe+vuwaiArxARH9P7VjaZFH5VgoAS1YdQPKxvOThzVMGQ8br
# AsL7bh+uX5B10Rbnvpb1IHQCsU8CBYcN5YRPuS/0hOcaKZ2L9ca01fEyo8rIqnM9
# WwPJQTF5xDUPdI8NPZ7IRPlnTfYBhteJRtpDgrcAzOzjPB2S+p7aW3if/W3qVb0m
# /Y/uRnENe77RGuNT/VbagKthivzUtegkChGC35WYvrlWuqbgKTwEyNjJje53tU95
# 3uUMabP2mtSOqSaFUAPrzngJctVALQ9pAgFaq1LsDOb2FjW0E+USLdOGF/Ohgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCAmfsVvmkydyy7gXdJS/TSMi29VO/R7X3+a
# rDykxKWKfwIUEMGOowR3eHeKxy9br7OG8G6MhfsYDzIwMjUwNTEzMTg0NzM4WjAD
...
# MC8GCSqGSIb3DQEJBDEiBCDDbHaQdxgVnY1seTKJYbWk8+Xu+8p5pAIr3YOHGars
...
# CwUABIIBgAr6HjlHc2XasEDTJFQlJnb4ZOUsCU7uaNd5piMcXCUr7R3IT2nQPZ24
# 9LQv07wqBqtilWl9WbYoPy8RVxgOa4JP1aDPYdxDZhWA42AWt8e0fB3toVO2Lim2
# uvItURGvb9ktwasiFxrhr0b2dtO8VfZCnElZWOaORJqW/js8Yy5KWkmb9vSFabPY
# 3TIkFBNRLP2Ab/S0nsSCefr0ZjDm4Yxyu1o8tqdCh9Pi5VW27KoUih1IIvTY5fEm
# u6ro+kBrEcC0mBXUz/tvb5n3fJV6rRLhPWW7ZkdrZGSv52fJOptrpkdsYOaW38f1
# D+xb0cKzvx37+69LHUXIFZwowNQGYZ8e7Gt7Dmzez8KSztk/NeF/xIYlKD13leEA
# mTEMO1UsNITNom41V10ipO9fNpBNG4qqf9Pop1ZRPu7kyWsV2Gn7jvCN9vVGRq+x
# +uxiPwfJko+HdYKgCGMG/eCXY3R4ZMqV5TLmCtUcS6Y0nku63hieRhoo2s9KeTrR
# f5uQ9C4Uyg==
