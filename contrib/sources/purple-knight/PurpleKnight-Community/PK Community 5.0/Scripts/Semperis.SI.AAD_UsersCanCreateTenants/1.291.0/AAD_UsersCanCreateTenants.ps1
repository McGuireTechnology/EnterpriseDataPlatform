...
$Global:self = @{
    ...
    Description = '<p>This indicator checks if non-admin users are allowed to create Entra tenants.</p>
    ...
    LikelihoodOfCompromise = '<p>By default all users are allowed to create additional Entra tenants from an existing Entra tenant. When created, the user will be invited into the new Entra tenant as a guest and will have Global Administrator access within that tenant. While the new Entra tenant will not have any resources associated with it, organizations may want to limit this from a shadow IT perspective.</p>
      <p>If users start associating resources with this tenant, and it is not managed and monitored properly, it may become an easy target for an attacker.</p>
      <h3>References</h3>
    ...
    ResultMessage = 'Non-admin users are able to create Entra tenants'
    Remediation = '<p>Enable <b>Restrict non-admin users from creating tenants</b> in the Entra tenant.</p>
      <p>To enable, open the <a href="https://entra.microsoft.com/#view/Microsoft_AAD_UsersAndTenants/UserManagementMenuBlade/%7E/UserSettings/menuId/UserSettings" target="_blank">Microsoft Entra admin center</a> (direct link), expand <b>Identity</b>, expand <b>Users</b>, and select <b>User settings</b>.</p>
      <p>In the blade on the right, toggle <b>Restrict non-admin users from creating tenants</b> to <b>yes</b>.</p>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBOQFSua95Knshm
# A7WG/1Blv8pHgWBz88BXJu6S9HLxwaCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgXLs1H6ig55XUIahQBSRGSR/JYd2joUeM+QudUA09p8wwDQYJKoZI
# hvcNAQEBBQAEggIAbrY2ziTZ66IvpcMN1ZCAQU7djS2Nv8JVgCEE5IJw6K5ySceN
# tYQ2/imKHMEuvhTEMaLejkMZCFWt5OudWPqDqs0TgYKFvUY9SGqLJgvYqWwyp68+
# HU2yk9MZO1oGW6W29bYTzXYM35de2YNe/mfjOSjn4iN3i4P2SeAb3QIvvEEydiuD
# OsdIS/i37getuA+K8h9bxmdul7NoBgXpAjl+tRQ7B7srxUrkvZscmz17uE3dEmCh
# Q/HeuB3MyvdH3Mtk9VYyfeIQus+4FUECyUbbbR+TdRn88BXgvk3IEIpv0Jpz93ZF
# WYXcH2MwXBZD/H6d7cVGMSPxd8/bUHjy5EUkL5DA4BFp25l6lSziJeJMGAa65jAa
# 7+WPIwTf5BvyBALquZ7cPtG/g7wEAarBOB/v3w3ol+P48lkGmNKnQ9h4YxCLgeFL
# 16KL0R+cIMXqrWUP6t1bh1y8upYYgkeI0SGJWzP5BWYUFekbtmIKB0/9tGULBJFw
# e4/MQc0Mefdj2bzSO0gm7FLtoTjn1yuL3I6+FqBeDC4Q9kIqLCGlQRa9YRyNCWNc
# Z9nJsWacyt9vyX3YU/j9n8sR4rPr8BL7AfjxO7ZiuNnAT33jTG7QpK8zDN8fRBXD
# cspUpLfNNPFqqeTUDHlKN7JEeMD6hArTormqWUlM6AjpZyGjZYvsT8IZEn2hgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCBj0wNPwHp64frLjgpjAC8x9JcB9VypH2wy
# cgA+phaq7gIUa4IDUbh5N5f2KmlG4lCwOtk1IWgYDzIwMjUwNTE1MTIzNzI1WjAD
...
# MC8GCSqGSIb3DQEJBDEiBCBYYUuW/haJuEvIHmfmIbFgJwzylO4UIY+qmi/PomXN
...
# CwUABIIBgHT+SueB11f9KhykyG+C1uriC5gD+ie7zrdmIpHeQdWN5QFnYMRnWZJY
# pWJMF5bGIRKVxCtR01jBFqkCKTwo95NcShBnWaI+jOKThDFt/5HPkEDput0UmAj9
# /PfrbyBhv4UIDLJleo2A3V0xGM1pOKj5h4JFC0o2C7/V7stvaeqaroCyXMz+WaW6
# ze+4HjVrKiIDWX1det9Om5Fk/LyelC0f3tWhRgpNfK9rbtq0dledrHCN3Dkxtn6/
# cGmg9xrtqCC/gDA7ThaBvC48g6wrGtO4tAMfTNqFDkeOfbAxFsbPTiL77UuAXxaU
# D2dfy+rK73P/KJHeTnAbKHuS3EslIg08Tjw3zwVprAa4RnYXkYbtja4bhXozqTrl
# oNiokf4B/DWWWzDbLQUw9bVqAZbi3R+dq0WUH/C9w6dLqJt0Gg9B+6lATMCB8rWZ
# 87ZCWcA5GUcNHKfFu5p7AHUwM/qdGFChtQlRMP2JYiefZQBK5Rpzs3pygAVYRdpv
# zebai6pClw==
