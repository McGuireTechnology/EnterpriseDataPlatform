...
$Global:self = @{
    ID = 160
    UUID = '549cb64c-1995-47bf-98ac-6456e7f5662e'
    Version = '1.290.0'
    CategoryID = 6
    ShortName = 'SI000160'
    Name = 'Non-admin users can register custom applications'
    ScriptName = 'AAD_UsersCanRegisterApplications'
    Description = '<p>This indicator checks for an authorization policy that allows non-admin users to register applications in your Entra tenant.</p>
    ...
    LikelihoodOfCompromise = '<p>By default all users allowed to register applications in an Entra tenant. While app registrations themselves are not malicious, applications can be granted permissions to access user data with delegated permissions, and admin consent grants can provide the applications with broader sets of permissions.</p>
      <p>An attacker may attempt to leverage a breached user account by registering an application, using the application for multiple purposes, such as attempting to move laterally, providing a mechanism for persistence, reconnaissance, and data exfiltration.</p>
      <h3>References</h3>
    ...
    Remediation = '<p>Disable <b>Users can register applications</b> in the Entra tenant.</p>
      <p>To disable, open the <a href="https://entra.microsoft.com/#view/Microsoft_AAD_UsersAndTenants/UserManagementMenuBlade/%7E/UserSettings/menuId/UserSettings" target="_blank">Microsoft Entra admin center</a> (direct link), expand <b>Identity</b>, expand <b>Users</b>, and select <b>User settings</b>.</p>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAG2jtzQEHFB36K
# tMGANhoctxZbETfNALXFWBpnvCWV+KCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQg4dYyPCNTIl2RrWpdLYpXf48pgKOyRch3kmXZxvJRIn4wDQYJKoZI
# hvcNAQEBBQAEggIAatGcOfee1KTuJX168k0dcA6vNFDKT36aMzju8cGtG+OLnYWH
# wQKllvqE9MmzCo1qZOWs6zi4kO5IRLlnKSUQPCMwC2VkJmAdrgDDVmAAiDD85L9z
# jQ8LhkGKC7Mf7ts/FPqfr5XEnsjtONQf99Ensvkoopse75ksvwIMX77441t0/zjN
# cXTejhlxiQkwwhFYUXSOQprPFX+ayPeSffxG82833n/kCYe1jqREMYblyQK/ecq4
# DguzAHRktwGBL6i5l/Ayzi+pDOUAQ1odp+7u3kaKdr63HZ/gFy6OVLqdWc4fFdIW
# +RPjWG/omTigioupRzh9xxYAGc7GsTCNgY2dY5bPqZ0njskvEw9qXg4//Ee/YXJZ
# svASZJ4nYgJY7Gkf1H+eJaoPji26kr4Toez5peGu3A3Ay+luKC4szBV0ikFF7DJK
# R62jDC+gAyDx7/qiXjhXZT9Vw2FRpzK8BC2rBfd53kgBU5fi/BDyVNcx/5mQLLV5
# BcxAC4DOXfxeg3DTRoWH1DqkcgF2c3DYKBSQJGHq/Ui4HOkFINvbG4ay92r/iXW5
# xeUYgv+ii27F+l5EtPO07oXb2IknXEgJ56zY9klmegtHPmlcpWhOcqjLL70aXlEa
# d+z6jkPEhJJaIUDQNzuQavMHugGrM+HrhaCkhIyEFk/E4fFrcZyY1ldoT8ehgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCCuC2l1jh77gC383mvXt63+9YKiKg7DLEsn
# 0TbgKST8IwIUYOnxmPSTtp2ZdcAvVKAMP+tIjpYYDzIwMjUwNTEzMTg0NzQ2WjAD
...
# MC8GCSqGSIb3DQEJBDEiBCC0p8O8he03R2UI78K348BA0CzcuqCoqSeMfc9AOEH7
...
# CwUABIIBgCmhrki1sCv7QLccJyigtixNBCDJGWkcaWJuQSKWNMoqN+DQuIfeWl5a
# np+3x68RiAltIMwy9QZUYkG9hV6+nlj3bnqbYH5/NlVVyJ/ymXwI/zaSXE761OJL
# DrIPevqPM1vyVD1eD+PVITHvyy6dLYjtOIED9SwxKfYKjWhwHIMhn4bOO3/Ew6eF
# laXcyH4nKiyAm4KVH3fdhT68TmJxo13NTj9lV68dGPB2EPzW0Llya53NgE0VcqiO
# 5qnrpJGLcfejILzyZyB9WFKSrfmfZSLNX8f8J3GIgn0tQIu2u6f6HWFgsR9cOV6F
# Erg6wyrraFPv+IW+Qgl2ozwkdNb/O8smSVma0mb5JSRmD5pXLw9/hYx+lA4YoZ7t
# PUzIo2OUQ0CDz/ncoHzmwzg/QQtokvjbPeDNEVUPNTfihdq0XQCmKK77kD5d9zuK
# N6ddXpJBpGybwPIY1BU7Fr/j+EhCCckYaQuSQwbyMyofW4T2ZauN7tl+EWC3BId7
# saYt5hg6vQ==
