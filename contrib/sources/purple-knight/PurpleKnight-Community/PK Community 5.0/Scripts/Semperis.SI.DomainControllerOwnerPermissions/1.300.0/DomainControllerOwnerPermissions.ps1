...
$Global:self = @{
    ...
    Schedule = '1d'
    Impact = 6
    LikelihoodOfCompromise = '<p>Control of DC machine accounts allows for an easy path to compromising the domain. While Domain Controller objects are typically created during DCPromo by privileged accounts, if an accidental ownership change occurs on a DC object, it can have large consequences for security of the domain, since object owners can change permissions on the object to perform any number of actions.</p>
        <h3>References</h3>
     <p><a href="https://www.cert.ssi.gouv.fr/uploads/ad_checklist.html#vuln_permissions_dc" target="_blank">Dangerous ACLs expose domain controller objects (attack path) | ANSSI</a></p>'
    ...
    SecurityFrameworks = @(
        ...
        @{ Name = 'ANSSI'; Tags = @('vuln1_permissions_dc', 'vuln2_permissions_dc') }
    )
    Products = @(
...
try {
    ...
    if ($outputObjects) {
        ...
        if ($scoreOutput.Score -lt 100) {
            ...
            $res.Remediation = "Ensure that only privileged Tier 0 admin accounts and the domain's built-in groups, such as Enterprise Admins, Domain Admins, and Administrators, have ownership of Domain Controller computer objects. Any unrecognized owner may be a sign of compromise."
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCiYPWuFzr14QKm
# A9RaBSMF4B18PDDz/pUhv8aT9dNDj6CCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgv6iz6C/B/OM8B+etPx66C4zjKfjvjPrEO+1XXXvy5gwwDQYJKoZI
# hvcNAQEBBQAEggIAT4hDYXFlngBcPqhV3HBQOEKVn+STWQIxDo3iFc7DxpNQtKx2
# rnJ2g3crdkqQVS4QttmgLwfZ3pAZGsq55Yn2lCDcZBNS1dqH5dnLsIlxSmoUZHAR
# 44Uzd+hGOQdrnJF8duXYfC/ftFvtiMOzaur4/7lBVs33AyX5weXj7COGdfCFw9DT
# 0YE/xxBPq6FqRhfdOMc/ufNHL5qp0Pfu8tUZQyhaBG8qZMg5Tn8MhV+7bFU/mLOi
# WWrnBh8nkLjrjE29L7fOBff00BJiaIC8h//+tQKT58w/Ku02kh79qJHVhUBGhrkw
# DF4aZawU5uKOqkkTu/Ph/IxyYYQKt7VnvWd37vO/ayV5mVTYw2zYTI6VVru13JPV
# HCFCvyiVqUMF6O5MnRj0AozyxwILE4GDH/rrbBVdcM7s8RekRCJ0tqG/Ftxk44C3
# ClUjV7ulI5P/WxgPNa9MqRHEAXUAgSuw8PM1XUaBvypFGbA9/vNpSko5KJ62fyxQ
# LxM9I5LyAI79sIFO2/h+A0eFLgQD7zR5qgFObXoGaNWBsvKvi3GsxhenzCIlycFE
# G/BJNUUapUkTZs9FNDRPmtyr1z64Ogpi6I5LOeGZhSgpVhinNEVJVgXFOW964ZXp
# azqVl7vzxlYphnFIZB829Wkg/C0RrK2CJwK2pLFoL2mguSvILYS1ogn9Cj6hgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCCcIRROCXkvzw0WAl+oOjwoYODPPVHIgEYk
# WM76lKWhKAIUA5NL36SixDvggnfSljMiwc6RQzUYDzIwMjUwNTI4MTIzOTI5WjAD
...
# MC8GCSqGSIb3DQEJBDEiBCARCte6G7OUx99heix6Hq+VgWHnGZ3dy0TnstS6eg8y
...
# CwUABIIBgJjw8eG9FaqRjnfcPJJyn7KYP1FgKYxYIfM5u9O5WaJ0YqrGX1+FxhVK
# f+VjZRl/hmOVhMcO9Lw83kVxyPTnb6fRYzs5pcTrIdQij5pMoQinMdpGhr3zw8MK
# ryHFcP+JrxRpcG54ESXxMdBxQ7E5ctCN62ovVvVXJIajSeOYJDBpb8PdAPEP5q49
# 4U1tYkPlW2e+qPR2uRYx9svzinhkl5uYW02LzEkcRCGCVhl1AvAAzw4NFnRePNve
# t5wRnL6xKQytYQ2g4UpDK8C+DABI7mC814mzakJqab8n797XWOw4QOAqZt+/K4Gq
# BURuffYHIqWYM/wuq/76XrJFXJVuhArIf7ffhfQHCtxTv8PbN8DXQdzeRMEieTbh
# BB5l7QhJdQQkYpI8J5kWzNSs8Rkg/i5hekApfukvyGn7R49sAxTvqG70yo0Ji126
# RnTsFKmmUKQpt/VMCVWEsMEiPjyZhHlclJk4w1/bwGBWkq9kgKF2kTkp+4Q+QnpY
# HfaCXZ5LdQ==
