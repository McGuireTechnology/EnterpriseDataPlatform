# This script looks for domains that have obsolete functional level - below 2016
...
$Global:self = @{
    ...
    Schedule = '1w'
    Impact = 3
    LikelihoodOfCompromise = '<p>While domain functional level is not a weakness in and of itself, an attacker with knowledge of functional levels can adjust their approach to take advantage of lack of security features in AD.</p>
      <h3>References</h3>
      <p><a href="https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/active-directory-functional-levels"> Forest and Domain Functional Levels</a></p>
      <p><a href="https://www.cert.ssi.gouv.fr/uploads/ad_checklist.html#vuln_functional_level"> Insufficient forest and domains functional levels | ANSSI</a></p>'
    ResultMessage = 'Found {0} domains with low domain functionality level.'
    Remediation = 'Ensure that your AD domains are running at the highest functional level available for your OS version to ensure access to the latest security improvements. Also, consider upgrading the OS to 2016 or above, as new functional levels are available.'
    Types = @('IoE')
    DataSources = @('AD.LDAP')
    OutputFields = @(
...
try {
    ...
    $minimumDomainFunctionalLevel = 7 # 2016 functional level
    ...
    foreach ($domain in $DomainNames) {
        ...
        $adsi = New-Object -TypeName 'ADSI' -ArgumentList "LDAP://$domain/RootDSE"
        $functionalLevel = [int]$adsi.domainFunctionality[0]
        if ($functionalLevel -lt $minimumDomainFunctionalLevel) {
            $thisOutput = new-object psobject -Property @{
                DomainName = $domain
                FunctionalLevel = $functionalLevel
                FunctionalLevelInfo = $levels[$functionalLevel]
            }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA8mu0m9yt+JcZm
# 0OthZFHj2a0EVyrG4L31MC3LWZBlV6CCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQggqc7tUQQv1+E4Qz1svuSnfWI8ywcjzsfvdCwb/n+y9IwDQYJKoZI
# hvcNAQEBBQAEggIAcH0+ZzciGBOuwDpy3gppGcXL7p1o7m0Rs/fYh5sO2AfQw0zs
# GVuHh7rc/syHpIp/ALo0VyiAeMu9OFXpbUwnimM1AKB1gzzf4yrTCYIomkfZt9f5
# Z1C4Y9A9oxiMZJ2sIva27JaQu0psgYIxKdF8x7jcmzVHybeyQ5Y5yem4DdmUaHHG
# GBt0YPfgNy5CzRMvKlmprnXfc/YNbkypQGcp9P0S4t8hqITXfbGhkS04FMKJnA0u
# FzvyEwahLF5N4ccYOmCmXHapfWDDrwr6QXsbTm35AkNv2/Ed5g1JYwB9TPBzx2mi
# 3nv/GlJuVXxLzlJ4OzsJZIBInmKsTtCyVDHH9m6NaImYkZ3oPQ/a3RmlO4+zWLbY
# PgSX4qa1WisVfykqtdkvEMptp0JxTKgM1AIwmfaiWHwCWZj42y/mAHKjaJ19mBz8
# I2fXATqfoRkQYvqz5d25TbKzHkTvs2cX/nz4oUWA0WSZEguLx0mxSFiF2VB2sls1
# D3ULE7Fb1SEEGL8ogJDMYTAE7u1/k4bujMGbqp3tYwgF322uJ3QNbqtOJlQnn9aS
# jIaOTkNFb3jSklTKzpqBjgSdmtyDGSbbzi+TJp9zck01hkvkWYjIbJF3ml+xkxpL
# rdtgoDdSKGkjMZf9nleXmeeIgfZPgniI9WDA9g3nBhsudq7gfs5xJF3n7iehgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCB2CesUnMeW/JPJbctGgZ2VIZ8tjKVjT36A
# lviEipfOfQIUScgPhktoPephJGflEcuDVQxpk4MYDzIwMjUwNTI4MTIzOTM1WjAD
...
# MC8GCSqGSIb3DQEJBDEiBCAyts8dgAwDSiwSKlFXZxehUs88fG76ES5VCHRilchp
...
# CwUABIIBgITZiHUNyC0VzGq5j59NTLoVHSKOSIQ5r30IR2gkMFqPnvNwiuJWx+qo
# a3u4cz0j0zOrrGsdjyGVIigIUzH6oHkBBUY1Kn282sOpo4pSFv+4aJdiHRxonGO7
# aJztpwmKR/leiLZXUeRYivG3mISN2OoYwAYebAsc6AWYS+2TW0UgGMJX/OHkL5Io
# dNIXOm0wlRp8tFWpqqK5K9hYSrOPA12iqzgtCG8x726tDrXbCJ0hFg1jbPxetbC6
# iN8EIcwrfazG1k/5QT1WHFnHzEvhewG6pQVwbYCBv/jSgvZ5HFP88+QNPRmEBRgs
# xHGpqhsNk0COK44IUuLQ7FvETJlPMlKrC/tNaoh+VicmC10nYR27rcm0oCrMsffJ
# 4PVWADZaXEw46kPAB97j9rP3i473PoxUk9ZZnHaLwhmUgaTnBHTT9/37yhGZ0kBG
# Et6ax6n9MMfuDeIQnfb5/eiF6VbS7uCTYj4D+AnRRHVUJn1YufdRlahXjK3GOOkB
# h602utdiLg==
