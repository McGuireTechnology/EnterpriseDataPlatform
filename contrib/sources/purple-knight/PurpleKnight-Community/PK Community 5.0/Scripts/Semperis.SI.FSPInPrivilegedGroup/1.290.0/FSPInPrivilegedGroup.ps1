...
$Global:self = @{
    ...
    Schedule = '1d'
    Impact = 5
    LikelihoodOfCompromise = '<p>While not immediately indicative of an attack, privileged users that are not clearly marked as such (adminCount =1) represent an exposure in that they may be used nefariously without being detected. Since Foreign Security Principals do not have the adminCount attribute, they could miss being detected by some security auditing tools. Additionally, an attacker may add a privileged account and attempt to hide it using this method.</p>
      <h3>References</h3>
    ...
    Remediation = 'Validate whether this member should be a member of the privileged group.'
    Types = @('IoE')
    DataSources = @('AD.LDAP')
    OutputFields = @(
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA9ZZG56N+GlJBj
# oyuphBk/Kk/2HDVRuSMTsisNZ5Z1YKCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgqNi2OVw18F2IxJ3mFDWpm0NB9vGmBxWldkoH3Yi8b/cwDQYJKoZI
# hvcNAQEBBQAEggIAIIz60Yc7WVo8be/b3yXOchC3qVVKHb/2dSJCRcwFaN0212gu
# ltx3oO0v4OObyYJzN9It1gyty1FPtCzLTmEp7tLl3iXxwi/oEPHL6ZN3VDdMV0eC
# anx6uMOjb08heWWu0cKY35y1EumWBBeJQ+nNJxGXRCT2GyZ4rPmM10y2ZCmzVtjM
# dtCjXByKh1yxfm+OWduH6wgv02u+KmkpDKyWrvgDVz43854l+vuLUJm4EkrAp4GM
# Sb9Cl2XrybYlZ1JQotRduIa9+RwjHWn3sitdUkSMuy/Y3Zwg1oChG5ON0Ja7CEdo
# wBObKN+7uc96sg5POPL+Pfz9zO429fGoUuSc8NrTYbLGPABRNhEOlNhNwB5PVIFT
# VTUg8xOr+ogY+1Uv0g50N5BXyH2kfx3KMWAIsE10udI8M6V3tKislkcN6r2F/SJc
# /Huv9v8p9NGMZ7GpaIsENjyTdzH3aQPksEXja9M44mNoUmLeOJpUrTUUH7QhDM1x
# b6tnJkNYYsKsuffHA+abVizA73LC67zp7NiqCr4K9BIIhqZX5+KK85TjrFR+b/Qt
# HOSFTcC524pCyO/PXRsR6zqODm4NWAQv9P7N00nvXKS23qu7b9gRqUCqwTuwnZv5
# Vow4HGGsRrYg3BqOLmE+GFIJ0Z1pK7f20drWm+gtzS4wZ3GPch/Pg18M8hahgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCDRCxFYTDTVYYhF9ngcsXGerdPV3UNNYXJN
# mtzuMw5vmwIUPJZ8IS+wtHSb1uQooHWK9gkc100YDzIwMjUwNTEzMTg0OTU1WjAD
...
# MC8GCSqGSIb3DQEJBDEiBCDTqvj2uUOXxK4OgwL0AZVHUJuC71m2xaknMP9/GnTX
...
# CwUABIIBgDqLkRaEg5Fj1mJuJULmgMMmlsCJPrMCdpsi8z8nkFjWMHbrSaaxV54X
# gUiwSeVfJzH4uRaLaIAXb1vxgiXxPs7BeTflwR/YrzfJISECFJPBblgj6D8GK3QU
# yamCw/GDvn2KieF4DK3xJ+WERK1E+2k0aQchPGc5u9iNG5PSz7yzzTAWWWs5MQ0I
# Sacc67Kllzx4JVcPRceNx19SjH7kRsK1kXHfcHIVqkz7dvOIPo9qOotL2Gz1DZY7
# JtQWsMAopFIi58/srheCE7M2ytZu83tPM8zi9Is1q/9zQshyB+0MzjCLJm5tA13v
# 5qX/YiYy39B8kI9obFEmmrH+hyoeTfmMs9I71Wk4/v9I4+74r+e5woG/SJB2DgzP
# wljdu5pEUJUbmRVPMrjwVTsvde3IZh4e2Mup3cbWP4wJ+FfR7RYsAAmMpCE8g0Qq
# 4aQaAoX0kiusX9r9Ux3MZzpE6gJIjbbKoyEKEN4sy1rSBPEfskEoi9j9hBGeiAOv
# 93B4DUoMxg==
