...
$Global:self = @{
    ...
    Schedule = '1d'
    Impact = 7
    LikelihoodOfCompromise = '<p>An attacker can potentially exploit the user rights granted by a GPO to gain access to systems, steal sensitive information, or cause other types of damage. If these dangerous user rights are granted to a user or a group of users, it increases the risk of an attacker being able to gain access to sensitive data, systems or even perform malicious actions.</p>
      <h3>References</h3>
      <p><a href="https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-10/security/threat-protection/security-policy-settings/user-rights-assignment">MS User Rights Assignment</a></p>'
    ResultMessage = 'Found {0} non-privileged users with elevated permissions granted using GPO.'
    Remediation = 'The remediation for this indicator involves identifying any dangerous user rights that have been granted through GPOs, and removing them wherever possible. This can involve reviewing existing GPO settings and modifying them to remove any unnecessary or excessive user rights, as well as implementing appropriate access controls to restrict access to GPOs and other critical Active Directory components. By taking these steps, organizations can reduce the risk of compromise and help protect their systems from potential attacks.'
    Types = @('IoE')
    DataSources = @('AD.LDAP')
    OutputFields = @(
...
try {
    ...
    $trustedSids = @(
        "S-1-3-0", "S-1-3-1","S-1-3-4","S-1-5-6","S-1-5-9","S-1-5-18","S-1-5-19","S-1-5-20","S-1-5-32-544","S-1-5-32-548","S-1-5-32-549",
        "S-1-5-32-550", "S-1-5-32-551", "S-1-5-32-552","S-1-16-12288","S-1-16-16384", "S-1-16-20480","S-1-16-28672","S-1-5-32-557",
        "S-1-5-32-562","S-1-5-32-577","S-1-5-32-578","S-1-5-32-580","S-1-5-82-271721585-897601226-2024613209-625570482-296978595",
        "S-1-5-82-3876422241-1344743610-1729199087-774402673-2621913236", "S-1-5-82-3006700770-424185619-1745488364-794895919-4004696415",
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA+F60qX5LkWPQt
# xC29UntYdlV+6UDLKL2600WHpykeoKCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQg6vOcKdKNvWUYFt1RCzTxR7DDHfmRS0ocIMukt1lCwK4wDQYJKoZI
# hvcNAQEBBQAEggIAaU8/Db6d/1o3AgZvdSHWrI2L5nENDlnyA32EHJtC6wF5vwLj
# +uniwjcHRvUS2nTTYtksXVBEd+xsqohywVqTbaEvTVpLFyZm7XT7u2cELss31NsI
# g5SGrrhf8oCWgcfqmiptsJGd05zuJ1G9kMFxG25PmWkOtnJXDI/ONb5esjpSntL+
# oJU6AP9zCUPrWHvXR0KsqpqLbfqj/6Q7tS9ofayOr3oW/kSLxsd1nvgPj1w+ioj7
