#Identifies when an administrator role is assigned to an Okta group.
[CmdletBinding()]
param(
...
$Global:self = @{
    ID = 300
    UUID = '4cc1d625-2fa7-40e0-bbc3-09cac81ecd2d'
    Version = '1.219.0'
    CategoryID = 8
    ShortName = 'SI000300'
    Name = 'New permission has been granted to a group'
    ScriptName = 'OKTA_NewAdminGroup'
    Description = 'In the last 7 days, permission was given to a group.'
    Weight = 2
    Severity = 'Informational'
    Schedule = '1w'
    Impact = 2
    LikelihoodOfCompromise = 'Members of a group with high privileges can perform significant actions in Okta, it is important to know which groups grant strong privileges.'
    ResultMessage = 'Found {0} events granting permissions to groups in the last week.'
    Remediation = 'Make sure that the permissions given to the group are indeed necessary and were done legitimately.'
    Types = @('IoE')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB2RmhulinfScBZ
# qq+nFTnAV3Pr7neQSnPggU7R314hzKCCE3wwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# FTAvBgkqhkiG9w0BCQQxIgQg5heoo3zwuOVe+RV/wAyqXkrkIyIdLi1bfv2Rtv7C
# P1swDQYJKoZIhvcNAQEBBQAEggIAKfqPn/taXTwsiiwXZmHpBWpEFJntvV4PiUNF
# APXBw0kRkg7w95H2qsJUF2fEujgAhuPkh3iRVxMSanOnIc08ITnMyl2lnXhjE31y
# CWojzW+KuyiBjDf70uiDtzCll0dVYmwmi2hfAfjogNVxKNHyjJSCIRzSFb4vXZCc
# BTWwMV5HfZX0Bb5+pBR1lbHJCL9Kcd7poIv7DPYR2nboesdSLJuQxRs4di0phJDP
# k0p3/7bItKgXOaoWZ1kbRImvKB6LIgoyFNzr9+iUypW92bwjjkYcmvsDYmHblaib
# rjCU+0ptqUUVsfsVhvUhOxAaNYHryleviU8e+Rov/9RutN4a0iJvR5rp1ulfObIK
# Nl3qAiStakm48vPzWWDQedNh16fItcVGo6Rqx+VPV/q9/78AUsU64Kre57qj/g8d
# 0dMpI3G66SsYjCvguCJjLYu98ec0cjk6UhT+KvN7VKd+sc0MRbGHeuxVGSKPclCh
# /35e63uxWR58ZzV62ZNHUnQMPJAI8DJa5fDdin1Utmo0caWozPt8+CdMYlml077O
# V33P9y3lA5N4XdM4kEaEK89MPSslELRrT4q0c7vI0suZcQt95dDpi//vqn1V0hON
# pzq8wNKHQOVclZYtYditFvf70D3P5EjZBBZvRz0ZTFFasALo/gpbeZUeBmH8ivw9
# 8VTvHyGhghbJMIIWxQYKKwYBBAGCNwMDATGCFrUwghaxBgkqhkiG9w0BBwKgghai
# MIIWngIBAzENMAsGCWCGSAFlAwQCATCB5QYLKoZIhvcNAQkQAQSggdUEgdIwgc8C
# AQEGCSsGAQQBoDICAzAxMA0GCWCGSAFlAwQCAQUABCBY57khtq+XfuZuBnCG6R9z
# lc8KbUz3r7AobM8HOS4lVAIUbLjjmvA+wBl5w8Y4vXBECIHh0gcYDzIwMjUwMjEy
# MDUyMTI2WjADAgEBoGCkXjBcMQswCQYDVQQGEwJCRTEZMBcGA1UECgwQR2xvYmFs
...
# CwYJYIZIAWUDBAIBoQ0GCSqGSIb3DQEBCwUAMC8GCSqGSIb3DQEJBDEiBCCcSFYa
# jBV6eAALos5/WeJ4zHIH+qvhw/y5n/Qld8jinTCBsAYLKoZIhvcNAQkQAi8xgaAw
...
# GXV0ccmS10TfpZbruXAVMA0GCSqGSIb3DQEBCwUABIIBgANv0NQzmQWE/WTTU2rm
# dxtQzwIC+ICoVeEavc9KjEL54z1x10Hve1atJfnWH6Pw3rYSxa3M3+urSNwyRnif
# FjV+FGoycMGq7dvPDQ7QfagTATHdWb0WtO8HwSuxkRKUkeh4e7WWE4chxMkv9PY1
# XJqCR7iI3r2Tl4S5pYUMTW/jRQzHcZKRU1RYiHA5esoV0o44Tgpw2BXF3aeXagoV
# XLIiqfMb3UruHQuJBjQuSCgDxMpgGjnqEUrMdxyaVOeKV+Lfd9jJ75kwlpczH+Bi
# 2YXK9t9iQg8k1+lA4lSkZwC1LpzrsON6prQVH6Ewa5BVFTi1qszeiJl8Z1XwgQIU
# qV6GleDl1kVhb6bG3SqxSTHotPrEW8azDHe/AnP0HYcYVbfPwHZS7PaHOQhx2hsz
# tSSzDY5//+9Pc009sf8bLq4m7WA/43TwAxmfnV2SVILa15NhBr/mHMN7m8f99x93
# nMGt1xWO1ZObfrG4X3Erd3bBFhnxNn2pQiL6WicrgWDZSw==
