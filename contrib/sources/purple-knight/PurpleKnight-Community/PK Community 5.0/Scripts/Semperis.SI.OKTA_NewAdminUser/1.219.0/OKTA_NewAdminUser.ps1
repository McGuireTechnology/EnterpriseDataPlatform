...
$Global:self = @{
    ID = 301
    UUID = '21a15341-8d4e-47d7-a5e5-af541f4fe0b9'
    Version = '1.219.0'
    CategoryID = 8
    ShortName = 'SI000301'
    Name = 'New permission has been granted to a user'
    ScriptName = 'OKTA_NewAdminUser'
    Description = 'This indicator checks if any permissions have been granted to a user within the last 7 days.'
    Weight = 2
    Severity = 'Informational'
    Schedule = '1w'
    Impact = 2
    LikelihoodOfCompromise = 'Users with high privileges can perform significant actions in Okta. It is important to identify and monitor users who have been granted elevated privileges to mitigate the risk of unauthorized access and potential misuse of sensitive data.'
    ResultMessage = 'Found {0} events granting permissions to users in the last week.'
    Remediation = 'Regularly review and validate the permissions assigned to users. Ensure that the permissions granted are necessary for their roles and responsibilities. Remove any unnecessary or excessive permissions to minimize the attack surface and maintain least privilege access control.'
    Types = @('IoE')
...
try
{
    ...
    foreach($admin in $adminAssignment){
        ...
        $thisOutput = [PSCustomObject][Ordered] @{
            Operation = "Grant users privilege"
            Users = $users
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDNi7RcPW6rZYAK
# O8uC9SfMJPa81eRculh7APWwbzHlOaCCE3wwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# FTAvBgkqhkiG9w0BCQQxIgQgfc7uiOjKYWmLE3vE8LGwl7YIFpJxqhcyAS6AeQUa
# +CEwDQYJKoZIhvcNAQEBBQAEggIAS8l2bAjc/UjTj4Dw8Bl6DvjKRltiCT2fxS0r
# oNFUAl/wC6yolfpEv95uvIgRLTdCKPWLTp/WWZTu1VUim3zDmyGBS7SLnrJOYIBv
# KF6PJ7cgH5SfH9cpWgUQ4//7UwXY8ibOJHLSZxhqGAuyRxCUjDPbBD3AOj73pYxN
# hXnLt8TCXJHFd6PtZG3sIoLg8qDp2ea0foYiZ/LUWHGK3rAj7qyfueeNSZQ0X0jD
# TZRzNq+/bZE7rBfXVOHFJWj3GpSPgxcmZAQLtvWk8BcL4W9RKqsQOp0Gya4Vzl0g
# N0auinbgr46SIvMBTMyuaoUKJXfnO6blN6fkBIFy97r1ZpK8GYBkZdlmbQmxi57i
# 8GCf1xkkEnEQMzJTCQunbpyyACHJKkWOmETBYWctDFJAi9hrBqIp/seyI3dChrQq
# juaZt18BIaek9JOx2xnuOalUYtYAuFMLvjyYb4sfCF6V1sALk0YpzS3T24tb1H/G
# 5eYdC1GlgrelvvxIiRmWeJH8fHnK8L48982s/hTTzi6neuEtki7aSmFT1lhDnkGt
# 9MkbzZmImBrln1dXVCuJOHYPjNH0h+3aT14KdA6HaIXnXMlcSGBqZ+g8daMQE76u
# YQObQFP6/ZQ4tS1q/2jyRcBhtwef2GLEFbElJf7EOpWt6BWwXvrDOcrCJjbwL0hJ
# ujKo1dmhghbJMIIWxQYKKwYBBAGCNwMDATGCFrUwghaxBgkqhkiG9w0BBwKgghai
# MIIWngIBAzENMAsGCWCGSAFlAwQCATCB5QYLKoZIhvcNAQkQAQSggdUEgdIwgc8C
# AQEGCSsGAQQBoDICAzAxMA0GCWCGSAFlAwQCAQUABCDJeurPd6YV2f8BGPkcIp2V
# 62q0HQIEJmavFmKXn0cVhAIUO3kerJenIu+Lusj7lqQNZ5iEuoEYDzIwMjUwMjEy
# MDUyMTI5WjADAgEBoGCkXjBcMQswCQYDVQQGEwJCRTEZMBcGA1UECgwQR2xvYmFs
...
# CwYJYIZIAWUDBAIBoQ0GCSqGSIb3DQEBCwUAMC8GCSqGSIb3DQEJBDEiBCBvTu3X
# J01AInWdtNZN6tYdC/c8k+gNfbzvyueoE8/rHzCBsAYLKoZIhvcNAQkQAi8xgaAw
...
# GXV0ccmS10TfpZbruXAVMA0GCSqGSIb3DQEBCwUABIIBgJWEDdwU6TDIEfu4IS9I
# rUHDtBf8tpOLXKFXB9VJi42ojGlcKBfxIb05UceZbagj4yYYQuxoHzj8v+uXq2iQ
# 5FaQePtwfR1OTz+PQ6yBfnCXDb8Srf3Be6u1VzEaFcF02+Tib7fCM9e6ugkF04Mo
# Z5oF0nXXeUN2LRVkflbHOoH1RSLwa93bbIje7JiCU2T/rCgejx4A7VdYv6I0ByEG
# mBpalzk1WNoePwfSPQKHG3zOJKw0BVenYdNiMutrSx1r7pz5+4vTeYA1Tllu91Qu
# a2fotaO/K7ZTJmBUTuRb5C3n1/JfNedDrRojzcwo34uwqzgSS6RTMxdR+hHETiAs
# cB/4nozU9O6Mel9slFPwnM6Eav8xlYgzJJBPlDKSkV2RoXIuamhSwYZctbxc2pGX
# 5O/o1HzUC1DeDsXKy1VgPK+HtYtae8juYDAh1iPpX/nIJN2KWgyAmkvaqO5JQ0s/
# +q9+b917qqMs9vFU5X5/fNc2u8q+hSmreAALAcMa4SMUOw==
