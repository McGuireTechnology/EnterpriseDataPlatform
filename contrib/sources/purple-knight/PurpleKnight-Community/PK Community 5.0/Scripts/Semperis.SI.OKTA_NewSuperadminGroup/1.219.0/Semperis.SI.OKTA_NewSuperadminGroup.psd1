@{
	GUID = '74e7dd15-b715-4926-bb7e-71c12d3ced5a'
	Description = 'New Super Admin permission has been granted to a group'
	ModuleVersion = '1.219.0'
	Author = 'Semperis'
	CompanyName = 'Semperis Inc.'
	Copyright = '© 2022 Semperis Inc.'
	RootModule = 'Semperis.SI.OKTA_NewSuperadminGroup.psm1'
	FunctionsToExport = @(
		'Test-OKTA_NewSuperadminGroup'
	)
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB0vnxb1W4NYik5
# 8SSUeL1mQStSriDNFSWAEuoVU7B90qCCE3wwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# FTAvBgkqhkiG9w0BCQQxIgQgCefdU4fGy7l2bdXtamMNX+jKXf/kd0IYssyQECde
# 4+kwDQYJKoZIhvcNAQEBBQAEggIAVewl0WufugesTUHAWZO7DwCOmRlnzms2QoPP
# ZRftZLZgULJ/0US2MzfcIHfDEK/7OBxWdZ6XRbzLPbPc12kQRRkuNXF6OCQMEozh
# UOf6URr4LFO6HpolP7cIt4qyRz0GhrFc8Qggp8bhEuNpyYLtzwQPWIZvYXOC8l/l
# /xQWFyVnlk0LJBbAuViz0/EfsbN8b8VBlweLuOHANsIqUSUodZm6QszoZgJZgUKj
# k+zplQEo020OBRim+5f+QYi/x+NijROgaSTy+71Wg7jEB+kpteFXYmSViLsD3/Au
# nGNetAQlYvJVg45WCS0+BD9rzcDWSw+Z0QZgrfQcDf9YIeNG7z+4R8QSLDMRxMm7
# K91lg6NMo1RgSND/yjLxsgKRGuPG2rpUfGCikgiuYGGelhrVUhbOKZysk+jmRAnN
# gkyBlELNUpjkJt8mwEZxAkiFoN81g/k2/Ol3mPSK/tuMdYopboP02fP36V912mrq
# MqSM85xnk9sw/s2DQC7rWxmdcDYLsqwGIYZB48TGZS00f13RigEuKJX4MSpiOO5p
# UkqerL/JRY/tZVDKlZJ2FteBotu4e7ZjGAH1nGr7Pq59J5DqiYo/bqtU408Z+L0B
# 8N1iDP1aDmf8tyOx9NAciEksE3GaMh5eUEfm5zpKyUvsEIUOQQxTBx2enb40jgJv
# eRKIQRShghbJMIIWxQYKKwYBBAGCNwMDATGCFrUwghaxBgkqhkiG9w0BBwKgghai
# MIIWngIBAzENMAsGCWCGSAFlAwQCATCB5QYLKoZIhvcNAQkQAQSggdUEgdIwgc8C
# AQEGCSsGAQQBoDICAzAxMA0GCWCGSAFlAwQCAQUABCAhNfIi35VbDT5vVVQj49Kz
# KdLCec5qJB8R/ngIx4qxUgIUP0+Yagl16kTsBwZ8XFCxyYotnG8YDzIwMjUwMjEy
# MDUyMTM3WjADAgEBoGCkXjBcMQswCQYDVQQGEwJCRTEZMBcGA1UECgwQR2xvYmFs
...
# CwYJYIZIAWUDBAIBoQ0GCSqGSIb3DQEBCwUAMC8GCSqGSIb3DQEJBDEiBCCbMvSL
# qBm2JynWGdq5gsI6C+B/yAeuIwweZ5qINXh/2DCBsAYLKoZIhvcNAQkQAi8xgaAw
...
# GXV0ccmS10TfpZbruXAVMA0GCSqGSIb3DQEBCwUABIIBgJLX21qCclgpws+etOHc
# si81PG0Fd8gMYv+AevKCGFDtrQvDICVU3lfDNw36QWgCGK8qp09659FsB/JuzTsN
# Ap5e/LKKW+LMnQn2pUkmzbMgo5dWWBdiXcG+roqbS0jzdNq/8xGiQssUUyClpqfY
# MVwXmMgtG3g5RkU06c9s4o/tUHEz2crXskvG9VzKW69tCoECiiruAcP4anGzUcMw
# U+smR1mKo5s6G2Yqr5ttj69YE/yfbBNeqXSDNNd+0QoJHZPCHB4+Jfs8WbPAcCJC
# mDMafedEbou9VyYqKG9z8KeYabCDojf3MncOR+jWxsuyn4nSOotfX3ARR/YnowPA
# 4gmM5Bo9AhQCP/sTJIwbEOMfzek+QgbWwxnx1vyE3zxfep5URpI57MYx3uQgIBTM
# uDDNUrrmrB3rEvKzx0vgwtyq2+bNPOyKyGlVigL9rPY/jLKjcKSa2fOk0ikyb6SO
# F1+Xved4Ah1oS3FcBGQSQ1BiJO3PaTcitfOIyTc/Guje/g==
