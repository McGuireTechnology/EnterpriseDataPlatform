# This script looks for objects that has values in msds-allowedToDelegateTo and has the userAccountControl bit of protocol transition not set
...
$Global:self = @{
    ...
    Remediation = 'Validate that every delegation configured is known and necessary.'
    Types = @('IoE')
    DataSources = @('AD.LDAP')
    OutputFields = @(
...
try {
    ...
    foreach ($domain in $DomainNames) {
        ...
        $searchParams = @{
            ...
            baseDN = $DN
            scope = "subtree"
            filter = "(&(msds-allowedToDelegateTo=*)(!(userAccountControl:1.2.840.113556.1.4.803:=16777216)))"
    ...
    if ($outputObjects){
        ...
        if($scoreOutput.Score -lt 100)
        {
            ...
            $res.ResultMessage = "Found $($outputObjects.Count) objects with constrained delegation configured."
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC4A2G598oOPbNM
# ZEhwztaaVeDozSuQtiap8WZvBp+0xqCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgM/Wo/AVzWs1cwCtudGYTAEVFLnyB1cxJztK+qLnWZu8wDQYJKoZI
# hvcNAQEBBQAEggIAaWeqxVUGEvZjWOox7C72GZf9n2vJmQ0ZjvvjmUa5BnvP2BXj
# aHSCNTZAA92Ms8EwN5QBVxh0vT4RgZlLX75NarrxmMUl1EtEJNpr+jUnT4B0/bwI
# osE2ycIDPubN4llPJs4npq4KiTtJlAT2284MiJ9GUJmScXhKrtphtkEUfeaZJii8
# e+2VIoCtyhycd2QR6pUApB63Dnn182f4gKf5U2caLYnXASXrbfoY/m4dnsn8KX0y
# Depyo2F4y7ksf0T/M5IjVjjmsSFyfZhA/fr3PRuFz96VbKGOjbINtj7TVceVzXP0
# zWErC160qoZysKFstr8tkNvEbJD806vDqaWDC6O81cinSfS55YW0socSaPbzMAoB
# UNjluV1002pNq8vLD8Mzwq4xTMzBZ4H4brmfZL6CpgvCaPVY6+gW2cAtcHtUaKXN
# suq8wUP4gAJ1qNuxkCBbuYxH9Z6zFLHss/kbLJU+IyAqNi98wa1KvJivbj/xpQ8F
# sZbJvuTlMV+NOPm5bUIW0uuxSmTB+c2vl6s4eURa5S9gl4Yrn3CSSU7rkFoofEuW
# znYubuTyN9ybX4WYwnmWYRR2moWXDLFi8c0MF+xnIR37wEnLrxieWrPJ7fMEGAxR
# pUnog8z0pOH7gtq2i0n6G5QwC2WOrqmdEMHSDnJpj6yJvNuTyB5M39Ej2kShgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCDcloo4MJfElJRu+Y6MIfswXvXF5BlsIVsu
# wgvFyGilaQIUKY7rlaL2AXeey/MdfkA9m3k48XAYDzIwMjUwNTEzMTg1MTE4WjAD
...
# MC8GCSqGSIb3DQEJBDEiBCAc0FjiaBM7ABsUZUa9VLy2CfbfxNFIbIaZYtuMCPV7
# 5TCBsAYLKoZIhvcNAQkQAi8xgaAwgZ0wgZowgZcEIJGSR5tiNbl2Jr+2AW14CJGD
...
# CwUABIIBgG8nV1XM7OP67vt35swPthfctuno/1iIBdtG6T9yw3ScmgnU6QtYGNkV
# YLQ4YW67sJ43CmMBAyBUB6jd8yf2RwOQc1q4dLBPexrCu8U13aqi+LsAoND09Sk1
# sZHwVr32Ln0zA03pCCW3J0zIkCfWkUdZwmHdqm7+8lAdvHsSmo6yvhbJn+N9o9uX
# ORJJOB/PAqYw6HoCVcZgOxfSgg0pv1PVla+sUI+zOar80kayIekos05rLFG6CYWu
# t/XM4P2n6FbKtlt73990mcWD1tqTqmFI1QkNxskA/q65IblzJss3K/L8o6f3XcbV
# 5NkrqyWI5eN/K31+dCEcSNdalUxiHi6uZ306w0lTyngyijid5OjaXGZO4e+yswAg
# c8CycmcvevYLPJKAghAHS3WiuMSaXVBjVPgx+UdYFc9BFgad5DvVY2nMxWTPKt33
# nLnGG4wXAtworO3g7uvafZmaQiyKV+HjnYaKep7NvrzK/3PeRORU/excnKaZ5So6
# tu6BB/gwXQ==
