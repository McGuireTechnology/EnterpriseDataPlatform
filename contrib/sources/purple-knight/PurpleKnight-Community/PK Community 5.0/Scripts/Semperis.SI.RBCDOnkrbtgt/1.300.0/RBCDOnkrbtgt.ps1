...
$Global:self = @{
    ...
    Schedule = '1h'
    Impact = 9
    LikelihoodOfCompromise = '<p>In Active Directory it is possible to create a resource-based constrained delegation on the KRBTGT account.</p>
      <p>An attacker may attempt to leverage this type of delegation to generate ticket granting service (TGS) requests to the KRBTGT account as any user. This particular type of attack is similar to a Golden Ticket attack.</p>
      <h3>References</h3>
      <p><a href="https://www.semperis.com/blog/ad-security-101-resource-based-constraint-delegation/" target="_blank">Resource-Based Constrained Delegation: Semperis AD 101</a></p>
    ...
    Remediation = '<p>It is recommended to remove the identified resource-based constrained delegation on the KRBTGT account.</p>
      <p>Some organizations may configure this without malicious intent, however, there is no valid reason in Active Directory to have this delegation configured.</p>'
    Types = @('IoE')
    DataSources = @('AD.LDAP')
    OutputFields = @(
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBNs5CfuRfHd2fy
# 21wTJZTqmRirFAIlP+WyMuiW3mBmFKCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgb9nuaGZ0X6dke6D8RE0xtIcdtVhhZUN/qqTUKFlXWwYwDQYJKoZI
# hvcNAQEBBQAEggIAFAr4AAgvOCQMkwAcRsBhMiGxjQdYvc6yug/lIGDwdFfyR47X
# 43zPkYjwGsZzOQmb+WesUoIOjCnRE+i632oEuDPYu4NU6URcStLH5gxAXYYA4RaZ
# PLBSNM6eqabKkusMxe+idVDEyoURTXjimREfh9oGFTV2OyOiatv7tfygaoLAw/aD
# 9JwOqC60+ctjqwgoAjwKUFq5y/hGtJnoJb97jdhsCjy9Dy9LioSqhdN9A+7Jf3rM
# 0If5AHxNDHSNQ7LzdQhA/Yg3H7/KKY8/hnrA2tLCfqpQVOTTQRSpX8aEXGGu4h3f
# /cOw6Ga5fWdcYkEWdY4Gz+GGdpPpbxmRKqElXuRe/4D+C/rbSvkgY7JWxIbTboQ+
# pHJNl5PNocDyKOhUbsYQjJQdYPfIH/qC+rwe0Q54PtYWjsr4b1ds82sn6/Z8A4t5
# ZFF1mjqu/SpWxFUj6PgdHL0LV+mW9P4Hu75AFf00vMfvR7PHD/CCcIwr+3Z1Cyy+
# SfvrBf0T9yH5SYBJO83Se+ebIwozo8XQumm/J9HJhy98SHTzixzDSagKFifeFzSW
# XM2G3YwPWYzlUMQDo9QOOBjM7UO7NNEDvlIPRhctHYTa2HgQAo2wjN4V6B/T+KmH
# eHiFMcqp0l04jP4Pdk91tRFRFIfrMXyPL2Z7mztPCjupczO5UmQiljG0YPihgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCBLU9IswNDHFVusl9/7s3yaiqYdQYMW92oB
# GCzObBHzBAIUReIkJT3RXU2arb85DAQg1gxNo0QYDzIwMjUwNTI4MTI0MTUxWjAD
...
# MC8GCSqGSIb3DQEJBDEiBCDURr88raMI9dfFuKxbiPfWyc+ke0WIvxZS3hlBTE7B
# SjCBsAYLKoZIhvcNAQkQAi8xgaAwgZ0wgZowgZcEIJGSR5tiNbl2Jr+2AW14CJGD
...
# CwUABIIBgH+Ls7GOSYN81pcGT5yaefCfgeLdaeRrBoWUVp9qQPcQKm+wy4osTynG
# asnNm2J0HaREgmIHKfs/Yen+9BVE6UsQrNCJlxS7vDuj3aQxoTyaVMi0maueLv0h
# oyB8re+u0FvGbaDqobbGYN1VCklHWPg93uftRlIhx/Y45LykLIC3+7We8Ery7JSH
# 3YSo70C0PzXcq1YVeVcc4Zz5XRnUpzgi2GV0pSuoc9RqQmloodzUdQUVmnlGVYpZ
# pySvx/d1wtbIxSV622G6wKe9KRBPP+8d8V1MBOQPhR6gx2QP6eQ7UjYEV5RM8Ocx
# yRCUfuzS2JDF4ynofxdTc1dSoZ8e2OEppZlG8L6WLbxMPMeBSa32xHKRwZxk66rE
# YHs3LWkUYX1Hi82SlYZuoen7EKSXnxJ41eR4/bm31+31x9T2R8dycnK1flis4O8c
# 8p8fyf/igBwImz+h7YHRJG0BXTnHOX2fa6cmEnBCDbuyZ1PiB2m6acJI7fMgvnU8
# WlHewYf3Rg==
