...
try {
    ...
    $monthsToRemove = 2
    $startOriginatingChangeThreshold = (get-date).AddMonths(-$monthsToRemove).ToUniversalTime()
    ...
    foreach ($domain in $DomainNames) {
        ...
        # Script block to filter just the relevant results
        ...
        $searchParams = @{
            ...
            MinimumVersionThreshold = 1
            StartMetaFilter = $startOriginatingChangeThreshold
        ...
        foreach ($result in $results) {
            ...
            $thisOutput = new-object psobject -Property @{
                ...
                Attribute = $attrMetaData[0].AttributeName
    ...
    if ($outputObjects) {
        ...
        if ($scoreOutput.Score -lt 100) {
            ...
            $res.ResultMessage = "Found $($outputObjects.Count) objects with SIDHistory attribute changes in the last $monthsToRemove months."
            $res.Remediation = "Validate that the usage of SIDHistory is legitimate."
            $res.Status = 'Failed'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBW79rQ6xDfTNYn
# s6EbPnuCnBhoyLqpNe6mn/4yQNdVx6CCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQg7jaPSFuJJm87ij9NvBnpB6bH4HfY1LVHnCSoDPoEuCIwDQYJKoZI
# hvcNAQEBBQAEggIAVYbt8gPmSRv8Dvutve+NpxGAoNyVN7pZ7euOMEVQ1bg0EenQ
# 4hQvjJkCKLWn6OysKkAhH6xqP4N10epECO5vY7wa2zqOWNJcNBDCqmfIFRyRCGu6
# lFJgOrdKCd5z79V7LrUbmu705A6c68puZXc+Pj+gm4RQ4zKyALPnilROmnXVV3DR
# Y7vws6mF9uusbrKWtKh75yKH3WUo1qk+qU4bv3VR1fcxz7nBR12t0VdJBp3XIxcN
# ES6grXLXhvYS+pOV/dSgk0JfOih+RAeaYCSKkIXJGOasBwHIhKQo9hEUR+tsibeY
# NnGSZrd700cbkVBfGAZRNoGwXlf1YsBCJRIx4U+tOeGunVvmR+6PtiuTBhOecZEb
# YBt8HoOWzEnNjhqnuIR0keD3s67vwUxljQYF2PShdBwiMwjRI+/ePXoWtkKO/378
# 8EGGxYsDixrOF4GwFlO1mLdGi6xL5YrV2g7fztLozXo4zgi+n+PB14lR9J7A9MY2
# U5rAty8cAdcqTdvteeoNe8qKvbcLTCF6+hAVBi5PKXKtm/CffRN/Xi84TmjN0iSf
# XS+cPdbc6z9HkKuvuxubltNV+zNujD/DknPFe9jZ5bsniU1S3uZktMHGE1pvBLfN
# XwhLLvjeCiBRd/R0UX+qkWvcwhcC0XlTtprI3os5PDG4++hFHhTZ/Ld/k7yhgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCBvJN+S3Jxa5j44gH20EZF9PsxXzaCqT2Y+
# 6f7G3OUHqgIUF0+GFaBOMXwyzFTnCaA3Dcgqag0YDzIwMjUwNTI4MTI0MjAzWjAD
...
# MC8GCSqGSIb3DQEJBDEiBCAKCDPxCoFzSZs2M4MgcjlRckDslNp9iyRWJbpKfPse
...
# CwUABIIBgLnXZzIUY8YdhP5WeJ1+PspE+thZ3ZQEcYHZt0J409HMR6VcNJgf1J8b
# isV3zCqSTgSypX9DbCfCPDcE8rF2H5J02JTNLPSe6W63niApJkLcR9PouuAbJ3/e
# ycuvFFIs9Ao3WcnuE5S+xjaA92g3rymiHiP0D6oe7Y31aW6Wdr0INT1ChDo/lCZO
# CxzAOI0+qCqeiSBUMYfbyAFj+mCJGzW7UvlIrH7syfhZwAIUXtow0IFfJIJNgo3T
# WXfR2uYUgVq3IuckUw9SKUrKwrmsRMVJ+Smmrw4UhSKgdZA0PeSiy5rfQLMze7EP
# DQD00RsDvGqVY7IU8lUzKJo97lI9494DysVkAnAV92JVOxqzTdBKmPRYmgsC38Q7
# mlSU38GNaq4U6iYFV+Y+Pd9z28aazdTPuXraYv91D4FiT8eIQVt4hWzFyLS6Eoj9
# ENio2vJ4Ni/bnz+i8Hk91utmoh4+IhyTXmf2t6cqYD8BkA0PhDNNpAl7jrLOCqOD
# XpGx4eblQA==
