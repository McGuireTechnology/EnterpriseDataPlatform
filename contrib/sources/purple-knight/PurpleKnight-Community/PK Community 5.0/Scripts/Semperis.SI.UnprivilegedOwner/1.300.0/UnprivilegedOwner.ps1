...
$Global:self = @{
    ...
    Schedule = '1d'
    Impact = 6
    LikelihoodOfCompromise = '<p>Most privileged objects are owned by privileged groups or users. But if a privileged object were to be owned by an unprivileged account, it could be easily taken over. And even though SDProp might correct any delegation done by an attacker who has compromised an owner, the attacker could have up to 1 hour to perform any changes on the privileged object (e.g. group membership changes or password changes) before SDProp corrects it.</p>
      <h3>References</h3>
    ...
    SecurityFrameworks = @(
        ...
        @{ Name = 'ANSSI'; Tags = @('vuln1_permissions_adminsdholder', 'vuln2_permissions_adminsdholder') }
    )
    Products = @(
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAEHRCv/PvldiQl
# hErB07Rgplp8WPWIsJN4ItwEp/WrBKCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgsazI+ZXTQOm5Rl4Q6weesK/RbHZpGbTR+etBqNpXQkswDQYJKoZI
# hvcNAQEBBQAEggIAHqUcwrQvdkNfUEvbpfIiNeFos3sl4pZNCKGz4qr+6q/kjXH0
# sR1imcMwDfifJ1QpE2MOkLYjjBEZvtUYJRSNJ+d0ytEuedH5YHN/mYcEnVDW56Dh
# qrf8yG6qNgFn5V/AOXvD+/k7xTgpNxxLJgqGZ11UwBM5UtNucuPuWvnqUMtknXH8
# ZVRrEJn4TkiJskU98BAZlRDIPqLhLYDN1UDzN1jUon/39ugPq66HDVvQzBU2YnXm
# Ku2k3PkhNkioBzubovcsOeDLeZfH8HOMCeh0Qzzr3TbSeImUvXLbkj28OKblPPRg
# 0RWgAu9c+MpUOCGOTF7AOcPT7yRsbzIBMUH5ZtxikgRh0i+qcOFjel88cGqzlYVt
# 4MUGgj95wK47RItkxvFL2qaINo7Zr0s7is0o9UZsCsnp7e/+FkQvP8UDX5KswcQg
# BvXitPBy9O1WLVecsXlnC240x+djwyqHN+MlWZvOd1OBSSh1IPxWmUKJPZq5oyx7
# e8KD7vipgYUbv3QSXdrxpfX667TVz5DiELHYHD5bJM+4tGIcaT99gRf6BHUrQUNI
# hJjSuP4Ogip3cQonYUrlgcm1lbxC5ufyafBzDU06EpxuNo1yDUR3hAnwdr1vezYY
# xSda9TpbPP3gOV/MpL3JJYpqwps0PwdF5tbAC83mkdVmaXPiOwgmY1mwKYGhgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCCz2l4UcRd53/WHgqt2T2pK33ChKi61CZEw
# bYKAuEhrQQIUKaXf5AjRSGs2t9vxaLEt3N54XtcYDzIwMjUwNTI4MTI0MjQ5WjAD
...
# MC8GCSqGSIb3DQEJBDEiBCC+xwE/EHd11MnQ5LU9PSPgEhvgtfi7Kr8GHt8iAJaH
...
# CwUABIIBgKac7o5CI5KzHO0ukXq/5kV5JnkI56eT+o+uDmwX8aSYqNwSJrfLOL0t
# nUutUHdQYf7jWS4hi437Pj3A48asISC2k1WqeU6RD+tcH+c3rndYLGhe+XTkyedR
# MulRxGAL39FFA4jCXog/B71YW0Fsu9a2IL/A7/YCgoDEDItFjZ946k0B5JGShldI
# RbrAhIbmPSDdE9sJKgetL7luGKbNdusVKreVLA+tx6lOWqYPrZujiJ0kGdfPQ8Gl
# J2L3B9+hSRSOlN43ABh5VkHH8QRD0CxgPYMuiU2nlLtUZVanRJQB8AxqMXUZV5vm
# By9F0LEdovIl1ep3eJ/dEJClQHlNRG163pS5kQmsrtBZzihfxG+GCSohd0i69PGY
# YVQ++o/W2OcMjVS447sZKjRCH2WLqwiTziEtlOl62ZLqqhCr28uYEEG+a5FM/G0a
# F/JIhds28Qj7YGWdCi3DC5n4oIo3/iLrw06gaLuU/M4+dA6smRDwUe3Zy6yVk6Mw
# DtFTHnWmfA==
