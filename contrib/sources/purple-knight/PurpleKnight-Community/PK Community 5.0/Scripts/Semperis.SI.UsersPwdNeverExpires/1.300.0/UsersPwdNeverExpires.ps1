...
$Global:self = @{
    ...
    Schedule = '3d'
    Impact = 1
    LikelihoodOfCompromise = '<p>Passwords that never expire may be weak and easier to crack. These credentials can provide attackers opportunities for moving laterally or escalating privileges.
        <h3>References</h3>
      <p><a href="https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-63-3.pdf" target="_blank">NIST.SP.800-63-3</a></p>
      <p><a href="https://www.cert.ssi.gouv.fr/uploads/ad_checklist.html#vuln_dont_expire" target="_blank">Accounts with never-expiring passwords | ANSSI</a></p>'
    ResultMessage = 'Found {0} users with password never expires.'
    Remediation = '<p>Move any user accounts away from Password Never Expires by having a good password rotation scheme and ensure any accounts that require this flag have the least privileges required. If this is a service account, considering using Group Managed Service Accounts (gMSA).</p>'
    Types = @('IoE')
    DataSources = @('AD.LDAP')
    OutputFields = @(
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBrD9RqarNoEgPL
# VtJMZd2/ycoGEue/JnunVnUp+YvnbKCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgRqwrakoyb6RsHPJi+8j7oZB9Tj3doq7o/raNsyZtTBAwDQYJKoZI
# hvcNAQEBBQAEggIABatojym+vbceXwNxjtt0m9VWR1DK2R+RKTdenb/1eMoqJfh9
# Cslv4ve4iSAVf6htHPw9p+BzvI94Dyg6gRlTfr0IKDZH/DWXoQqAAbZYhxpUV/Nt
# JVtVBMuHL3Ij2eGAc8n9M6Np92QlhkxKI6Ule0THj8vuOpVHctHikMDlm03sI+qT
# wFQbgiFEASOu7R6eEY9SaD15etXJHUzO7YzMIcgxJNYUbHlX+SvZi15vSI9X9D5i
# dqyxU4GLmt5Gqm9cwl7BmPQjAtjl2JBBZ4dzDifmAbPt3HqjOkNfP62+8ToWeNvo
# AX1O0bL90SBKSJAHhJ90uoGZTJtH3twrZFdZLI+SxRS74bJsA1DwtUvH2tDTfLqk
# 7+6lqAIQSG8MY/vDR5dChzk/0G7cDRwTimhQw31Yno1ry/velg+JuDE7z2XwlgYH
# 8eWiaVl+HpwHDMwmsXQ3VWEZqupHfF1vLfFWUQYFQ/bD8rjkkgYT5rfBQJOoY0Zo
# Sixns0Vt1Hn8iZ2AJJU1ZQUaxQ0EC9wtTBbx5jXaipqLQpjK9NiGOsFMQn7vXf83
# cVyBQnEdGNpt+8EYvwMwWJjIXGjyLqVrE98spyV/EQTkG07f4VXMAFugqQr2FXUw
# bsd+5fw+halh6Vm5kl4Kip0h8yT73DIoQGqnH3r/5KXnPljNLyudBSAIi0ehgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCB85doNb31tEXEkCL5XQY4QTmAjkI5sAS24
# 9oykO9YJGwIUfHvQqCMKXilQSV0dZpm8tDNr9V0YDzIwMjUwNTI4MTI0MzEwWjAD
...
# MC8GCSqGSIb3DQEJBDEiBCDTNv6da+CcwDVSsMCUEPPXX3DIB8pWgxCiNvNvrhmG
# cTCBsAYLKoZIhvcNAQkQAi8xgaAwgZ0wgZowgZcEIJGSR5tiNbl2Jr+2AW14CJGD
...
# CwUABIIBgJe5Q+H6AxWM+Yg/hP+lnjjNb2qVPYiR8olw5snYde5xCTXL1FHlxECQ
# Qsl34dktNJ1nLfbMnP3sL/AJj/iEkiPqdqxfgl8VorKVTlicfEdhDtTl3DcrY9Oy
# r4wBJeAMRbKZ3pOCzhaUukGUlXjM5uQaByQxVBU/5xB6iI0aNekxsQ8TrUer+TPA
# idoxZ8I7nHISfR8wf1BotIYQQI4FnEwCzEWcfEYcp3i2MJg283ElQya6qs/htYTK
# 4Ul4xWOwQrvtGbXYO5VT5y2wosyJYGC77faqAtF7AcgqqVfcb3yrsXk/ypqHE5CE
# H658EFvK/dijHEi7sJpl0PmU444HIjzc/qyAIF8TZrnv/TPU9AeUn/8MqDiMgujk
# yaoIO+5GVEyvK9g+GSy7ck4kLAOJHVf/72cRl124Al/tZVB9jnG/E5JelaWGPlsy
# MeuPc8qKeeyb0QJlu84n+VUXiNG7mYvLgMq6VJjWBgxsZqCP+cr0/6nOdidSiBQc
# VrO6DjeAKQ==
