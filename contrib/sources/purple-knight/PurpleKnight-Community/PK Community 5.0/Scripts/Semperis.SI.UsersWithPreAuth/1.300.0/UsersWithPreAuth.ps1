# This script looks for users with Preauthentication disabled
...
$Global:self = @{
    ...
    Description = 'This indicator identifies users with Kerberos pre-authentication disabled, which exposes them to potential ASREP-Roasting attacks, such as ''Kerberoasting''.'
    Weight = 5
    Severity = 'Warning'
    Schedule = '3d'
    Impact = 5
    LikelihoodOfCompromise = '<p>If an account has Kerberos pre-authentication disabled, it makes it easier for attackers to send dummy requests to a DC to try and crack its Ticket Granting Ticket (TGT).</p>
      <h3>References</h3>
      <p><a href="https://learn.microsoft.com/en-us/archive/technet-wiki/23559.kerberos-pre-authentication-why-it-should-not-be-disabled" target="_blank">Kerberos Pre-Authentication: Why It Should Not Be Disabled | Microsoft Learn</a></p>
      <p><a href="https://www.cert.ssi.gouv.fr/uploads/ad_checklist.html#vuln_kerberos_properties_preauth_priv" target="_blank">Kerberos preauthentication disabled for privileged accounts
 | ANSSI</a></p>'
...
try {
    ...
    foreach ($domain in $DomainNames) {
        ...
        # Get a list of all objects with pre-authentication disabled
        $results = Search-AD -dnsDomain $domain -baseDN $DN -scope "Subtree" `
            -filter "(&(userAccountControl>=4194304)(userAccountControl:1.2.840.113556.1.4.803:=4194304)(objectCategory=person))"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC0aYrSs0SXcRXp
# RYFknYtqBHj2mvbbzCdjCyUvDRgY1aCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgEfgI5fdtawUwn6fFXyGuydustDHBmcICZKJhmlrTzTMwDQYJKoZI
# hvcNAQEBBQAEggIAKTfmuQrDwnXR29bJorPecYEQgzcHWjgyyePOAVfaCs1MvhcT
# yvB/MRNk2LtTeYYYSZ3MwoM+MqE18FZIPurQF047vV9CmpzGOm58uKuPU4o1B2Au
# s1mIB2ncPlrRhckmbmhRv1+Vgymz9FKVvDTO5fW4mDQzWOSopxdBVqKFG20QctUX
# zw/N0c7az/+WW0+1EJ0aAYH2H8kwzErQ6eCOo2xdeAqpOFSit6fTaVd23/JajqEH
# 2bIslfaB5bJPJedmXDWvMRZpp1NtU/En9xHEJL2ipafoUXiWcQm9UTmSXIlW8s8l
# kjM/YC8GAGt9i2zD2cHmWYhQJGh1LgnH3MU22JFrgu/Rgvx9yXoyistjuVxeM/no
# H5CliNlWl/ZUZ2VNeVHLKvS5BYNBU1SxIYVTlII4YoI6paLIDKpH2fZsrmQPc5dN
# riaCI8x/2X5ezpS/D0eGWrhglOF9b5eG4dZX0c/bSP5DAitAHLZ3uApfu6cjkWIX
# IUbZi9XKlTBZvbNiff6W+kCvvEV0VwA10wXyc0do34xFD6hshjZkpi+U5BBxGWVT
# 6pBh2ms0k2PMTWc2NfXwa3TVqA+yH5+AfYG7ZzwOZ5aggMsdjsNMVxtsimA4zmg4
# Nw2oE/TudgT+JKsG+d0ONVrM1NpcqsqsRcheLmUf4hZV89M8q6+lUloM6Cehgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCCDjZ321rdZYaKqT+huTXuBvc4L9HPjgF3A
# B0xBQiLIXQIUXXWzkIYTnfHwWwmozLPA9WuvsOMYDzIwMjUwNTI4MTI0MzI2WjAD
...
# MC8GCSqGSIb3DQEJBDEiBCC+ZeX7nQerfq8VOV4AjK6rf54j4cy7tu+i3aPvkOLW
...
# CwUABIIBgKjEdTQYmwMd4gwjqedoaNEbsuYrYBk+BL+dKbyvsayhdHaJTRrmZCDy
# GxqPGZbtcIGtC9RIi/BifS5GnceFaY/kguapp2R70GM+C50uHVeOo9/A3zoMMyqI
# ygAYx34TvhJ+hvtE4e8exAUwvxA1pU4m50fpNPMQwX/XSYvC3sAcs6Z1QHI++V1C
# vNbhnDJpgiZ9bA2itfnahH/FRefyBsjAunW+Ty50F/M+ctERM9HrT23ey+6aekaO
# vNnytvKXYL/y9LExptG7799tR3xcOsnLpMQq9n6rXyLYtu65+VwFhgQu7KUa23pq
# fAzpYH3pDiF6PrxJu0CSvspk8xx6HjicJejxut7f5xfO9kdG5MM6fN5FFBPK+1If
# aEiixwR3EPtf8XHGUj3gNFIrWCb6Y+AHqEw3QxZFrWhtnkvtyjm+/DDIrKkpJKbL
# Rdb+OiGuKRyWV9yyhlf5kk1wIZdli/E8I/zfzeu+hLSws7C7NMEQP/pqn+9UY0dx
# F+iLvkcHsw==
