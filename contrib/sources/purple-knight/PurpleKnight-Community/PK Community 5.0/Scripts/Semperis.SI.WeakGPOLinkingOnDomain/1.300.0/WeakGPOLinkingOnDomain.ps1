...
try {
    ...
    if ($outputObjects){
        ...
        if($scoreOutput.Score -lt 100)
        {
            ...
            $res.ResultMessage = "Found $($outputObjects.count) objects with write permissions on the GPLink attribute at the domain level."
            $res.Remediation = "Unprivileged users should not be able to link GPOs at the domain object level. Doing so essentially gives them the ability to escalate their access, change domain-level security posture, and use GPOs to effect all systems and users in AD. Remove the unnecessary permissions from the NC Head."
            $res.Status = 'Failed'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAcHIW5iP0y4mSz
# ZRRHODwUkVqgI095NEW0pocmi9gewaCCE6MwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# 9w0BCQQxIgQgU707zQ6rf5xZSMIXUVt3epH8NyX2byeyBzftLQQLzx0wDQYJKoZI
# hvcNAQEBBQAEggIAT7P0X55FUXTxok1+6U67jgBt4xFr82917Ghm11526OJJD43h
# MOGOpC+ZCTmHXtsYcqa4ILfqjfErgJKL9w4P8tv6rA9Bssh2PRLlYvumTPosxe54
# hHkCDguJexCOZqyCScJHp+jd/Ol0ihJRrlQyX8hMxrzpaePXhhkqSZSO8x7Yg21E
# yUYdOSYAPQocaejgLIPFgY4Z+/cC2YCkXoZozYNW5SdgaBeee8HCB5VaxIW4toU1
# ysn2qHCJgXA6J/gET/4cvU2w81PHHw7WexNN33pPR8IjPExkdDbQqqXG6ztpwxML
# Vt3VuUk6fvmohoPfztRYykOXGupIRIOonLyNQY3pLT0MI6TkKhCMoTdbk05XTiCE
# c7wpXym8u25K48dELE2AXnLoCQGLFKx4csPafZUbqvSxzRFAt89/GxEPvfwShVdn
# Hp8sr07FykAyvMALwz3wZgWId5jIrGYxo7UBBm4wAMibQY6KIzFKd15enf1ljgvo
# ANi8uhOtXlM3Z/EgFqhn684JRD0bIsQe3Q2XKf/BCrUhKw5lyVbXswIbBFsvrkt0
# ItVN1SxfQH+35rqVASi3KHPAbFZgS0qlp7z1MFf/SKxBIyqj/creXBiFP5k8UKxa
# kIozuDZc/vzB/ytzr4kcLr1IialZYdK0lhlstQEE56QBsC/U4Szbr7j5PHmhgha3
...
# oDICAzAxMA0GCWCGSAFlAwQCAQUABCANWAM9BacpFIxju4PRzgYV8uJD3H9ohoOw
# NyatWP6/pQIUN6O6AVfJooDuwKXJfaMHrOUrJxcYDzIwMjUwNTI4MTI0MzQ4WjAD
...
# MC8GCSqGSIb3DQEJBDEiBCAijBGidF3jj7xiFwXQFBVQtRyhBIA9j/MAyVQSCmLs
...
# CwUABIIBgFO/MK+hzkySsJeTTKZmOmT7281XPG22nNdvM92sMZotYvwkZrVu4PFw
# 8LHkflqAaZRWoCuQOd9JU0NFMOw8/iyxMWwD9NCxuUdlSBuuHs4u6mJht/qtE98F
# QE1n2OoWD2x7zhpaCYC5LThANkkY0iCwK7HHal1hp/p+wId6XgL68IM4vdWyIzAX
# fQblY0WYsMQ98JMdlnGlVv7dNV04wGqwntyZQAZzBY/vKNEmNoBudg3pHKXO8l3k
# ldWlkxlLFEdL4c3sTd7/oPKGKOxFjOLSDd7o1PpVjRbSVDztPzsyaJKhHcUVokoU
# Wr4krY2ilrIN0OUvnp1eMLCvzX9mPssOfkNVAbb20GPCLrMRehoAatzZfwPg+9tL
# cQJcTM/fkS8ikyPS/sM1owZvf23Iqf5c9yQZwGmFIxYchc6zLoJh+hXAkyYEnkaB
# g6TBOUxBz85fQnKvaGgtfgNV5Q4RSEAsr6UB0ej6zKm8BW+0cL0OQmAr4T8Y+bjS
# d4IROO3qPw==
